const Instructions = (): JSX.Element => {
  return (
    <div className='instructions'>
      ...
      <p>Challenge your knowledge and flex those creative muscles by writing sentences about the picture. For each text area, write a sentence that is about the image using the provided verb in a way that conforms to the rules of the grammar point.</p>
